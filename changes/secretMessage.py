...
def rename_files():
    file_list = os.listdir(r"C:\LocalDocuments\Programing\Python\projects\PythonHomeGrown\Phase2\secretMessage")
    print(file_list)                
    # 2 for each file
    #Rename files
    #new = ''
    ...
    os.chdir(r"C:\LocalDocuments\Programing\Python\projects\PythonHomeGrown\Phase2\secretMessage")
    # 
